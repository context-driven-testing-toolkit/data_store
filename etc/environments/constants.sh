...
export GIT_LOGSTAT_DIR="$FACTS_CALCULATED_ABOUT_GIT_REPOSITORIES/git_logstat_merged"

export GIT_MERGE_COMMITS_DIR="$FACTS_CALCULATED_ABOUT_GIT_REPOSITORIES/git_merges"

export GIT_LOG="$FACTS_CALCULATED_ABOUT_GIT_REPOSITORIES/git_log"
